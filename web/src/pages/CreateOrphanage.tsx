...
export default function CreateOrphanage() {
  ...
  function hundleSelectImage(event : ChangeEvent<HTMLInputElement>){
 ...
 async function hundleSubimit(event : FormEvent){
  ...
  return (
    <div id="page-create-orphanage">
      ...
      <main>
        <form onSubmit={hundleSubimit} className="create-orphanage-form">
          <fieldset>
            <legend>Dados</legend>
            ...
            <div className="input-block">
              ...
              <input multiple onChange={hundleSelectImage} type="file" id="image[]"></input>
